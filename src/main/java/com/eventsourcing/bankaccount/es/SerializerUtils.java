...
public final class SerializerUtils {
    ...
    public static HashMap<String, byte[]> deserializeEventsMetadata(final byte[] metaData) {
        final TypeReference<HashMap<String, byte[]>> tr = new TypeReference<HashMap<String, byte[]>>() {
        };
        try {
    ...
    public static byte[] serializeEventsMetadata(final HashMap<String, byte[]> metaData) {
        try {
            final String valueAsString = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(metaData);
